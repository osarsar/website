                    ...
                    <div className="users-info">
                        <div className="user-info">
                            ...
                            <div className="user-details">
                                ...
                                {/* <p className="user-score">{user1Ref.current.status}</p> */}
                            </div>
                        </div>
                        <p id="vs">VS</p>
                        <div className="user-info">
                            <div className="user-details">
                                {/* <p className="user-name">{user2Ref.current.name}</p>ww */}
                                <p className="user-name">Bot</p>
                                {/* <p className="user-score">{user2Ref.current.status}</p> */}
                            </div>
                            {image && <img src={`http://${window.location.hostname}:8000${image}`} className="user-avatar" alt="user "  style={{ width: "100px", height: "100px" }} />}
                        </div>
                    </div>
